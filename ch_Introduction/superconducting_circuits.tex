...
\inprogress{
In this chapter we give a practical introduction to superconducting circuits for quantum computing applications.
...
As such its dynamics in this regime are described by the Schr\"odinger equation
\begin{equation}
...
\qeqn{U = E_J \cos \phi, \quad E_J = I_c \frac{ \hbar }{2e} \label{jj_energy}}
...
1) For uncoupled qubits, we can drive the $\ket{0}$-$\ket{1}$ transition without exciting the $\ket{1}$-$\ket{2}$ transition.
