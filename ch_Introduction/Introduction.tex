...
Whereas a classical processor requires four times the physical resources to represent the amplitudes $c_{00}$, $c_{01}$, $c_{10}$, $c_{11}$ as it would to represent any one of them,
