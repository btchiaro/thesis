...
\rd{\qeqn{I_{c}(\Phi_{ext}) = 2 I_c \abs{\cos{\frac{\pi \Phi_{ext}}{\phi_0}}}}, Tinkham or really anyone}
...
\gn{In the next parts I show how the Hamiltonian is modified in cases}
This is basically a todo list for this the next couple of days.
...
The harmonic oscillator Hamiltonian $\hbar \omega \left( a^\dagger a \right + 1/2)$
