...
\bibitem{qiplotfn} Following the resonator measurements, several devices were found to have some residual photo resist from fabrication.  Since the best performing device was observed to have resist remaining after the striping procedure and only the best device from each film is reported here, it is unlikely that this significantly limited the stated performance of any film.
...
%\bibitem{Barends2010}R. Barends, N. Vercruyssen, A. Endo, P. J. de Visser, T. Zijlstra, T. M. Klapwijk, P. Diener, S. J. C. Yates, and J. J. A. Baselmans.  Appl. Phys. Lett. \textbf{97} 023508 (2010).
