...
\section{Breakdown of ergodicity} % Ergodic breakdown
...
\section{Interferometric methods} % Interferometric methods
\begin{figure}[t]
 \centering
...
\section{Growth and preservation of entanglement} % growth and preservation
\begin{figure*}[t] % Figure 5
\includegraphics[width=150mm]{./PDF/fig_5.pdf}
\centering
\caption{\textbf{Growth and preservation of entanglement between localized sites}
